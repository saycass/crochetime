class Project {
  ...
  static List<Project> projectList() {
    return [
      Project( title : 'Amigurumi gato', description: 'Amigurumi tamanho G cinza para presente', id: '1'),
      Project( title : 'Tapete vermelho', description: 'Tapete para presente', inProgress: true, id: '2'),
